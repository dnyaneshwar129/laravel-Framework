...
<head>
  ...
  <title>Jcart Bootstrap Template - Index</title>
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="/">Jcart</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <!-- <li><a href="#">Blog</a></li> -->
          <li><a href="/products/listing">Products</a></li>
          ...
          <li class="nav-item">
    		<a class="nav-link" href="/login"><img class="rounded-circle mr-2" src="{{url('frontend/assets/img/av.png')}}" width="30">
